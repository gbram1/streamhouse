-- Migration 008: Add cleanup_policy for compacted topics and wildcard subscriptions
--
...
ALTER TABLE topics ADD COLUMN IF NOT EXISTS cleanup_policy TEXT NOT NULL DEFAULT 'delete';

-- Create index for wildcard subscription pattern matching (using pg_trgm for LIKE patterns)
