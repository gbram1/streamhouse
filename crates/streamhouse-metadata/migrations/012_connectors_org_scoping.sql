...
INSERT OR IGNORE INTO connectors_new (organization_id, name, connector_type, connector_class, topics, config, state, error_message, records_processed, created_at, updated_at)
